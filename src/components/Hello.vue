      ...
      <nav class="navbar main-menu">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <!-- Logo -->
            <a class="navbar-brand" href="index.html"><img class="logo" id="logo" src="../../static/images/logo.png" alt="logo"></a>
    ...
    <section class="slider-pro slider" id="slider">
      <div class="sp-slides">
        ...
        <div class="sp-slide main-slides">
          ...
          <img class="sp-image" src="../../static/images/slider/slider-img-1.jpg" alt="Slider 1"/>
          ...
          <h1 class="sp-layer slider-text-big"
            ...
            <span class="highlight-texts">Awesome Design</span>
          </h1>
        ...
        <div class="sp-slide main-slides">
          <div class="img-overlay"></div>
          <img class="sp-image" src="../../static/images/slider/slider-img-2.jpg" alt="Slider 2"/>
        ...
        <div class="sp-slide main-slides">
          ...
          <img class="sp-image" src="../../static/images/slider/slider-img-3.jpg" alt="Slider 3"/>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 custom-sec-img wow fadeInDown">
            <img src="../../static/images/features.png" alt="Custom Image">
          </div>
          ...
          <div class="our-services">
            ...
            <div class="row">
              <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown" data-wow-delay=".2s">
                <div class="service-box">
                  <div class="icon">
                    <i class="icon_cone"></i> <h3>Software</h3>
                  </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown" data-wow-delay=".2s">
                <div class="service-box">
                  <div class="icon">
                    <i class="icon_mug"></i><h3>Bootstrap </h3>
                  </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown" data-wow-delay=".2s">
                <div class="service-box">
                  <div class="icon">
                    <i class="icon_currency"></i><h3>HTML5/CSS</h3>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown" data-wow-delay=".1s">
                <div class="service-box">
                  <div class="icon">
                    <i class="icon_star-half_alt"></i><h3>Mobility</h3>
                  </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown" data-wow-delay=".1s">
                <div class="service-box">
                  <div class="icon">
                    <i class="icon_music"></i><h3>Analytics</h3>
                  </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown" data-wow-delay=".1s">
                <div class="service-box">
                  <div class="icon">
                    <i class="icon_cog"></i><h3>Consultancy</h3>
                  </div>
      ...
      <div class="portfolio-works wow fadeIn" data-wow-duration="2s">
        ...
        <div class="portfolio-items">
          ...
          <div class="item portfolio-item web seo">
            ...
            <img src="../../static/images/img-portfolio/portfolio1.jpg" alt="">
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio1.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="item portfolio-item works seo">
            ...
            <img src="../../static/images/img-portfolio/portfolio2.jpg" alt="">
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio2.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="item portfolio-item web">
            ...
            <img src="../../static/images/img-portfolio/portfolio3.jpg" alt="">
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio3.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="item portfolio-item web works brands">
            ...
            <img src="../../static/images/img-portfolio/portfolio4.jpg" alt="">
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio4.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="item portfolio-item web brands">
            ...
            <img src="../../static/images/img-portfolio/portfolio5.jpg" alt="">
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio5.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="item portfolio-item works seo">
            ...
            <img src="../../static/images/img-portfolio/portfolio6.jpg" alt="">
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio6.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="item portfolio-item brands seo">
            ...
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio7.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="item portfolio-item web seo works">
            ...
            <div class="portfolio-details-wrapper">
              <div class="portfolio-details">
                <div class="portfolio-meta-btn">
                  <ul class="work-meta">
                    <li class="lighbox"><a href="../../static/images/img-portfolio/portfolio8.jpg" class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div id="teams" class="owl-carousel teams">
              ...
              <div class="teams-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
                <img src="../../static/images/img-teams/team1.jpg" alt="">
              ...
              <!-- Slides -->
              <div class="teams-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
                <img src="../../static/images/img-teams/team2.jpg" alt="">
              ...
              <!-- Slides -->
              <div class="teams-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
                <img src="../../static/images/img-teams/team3.jpg" alt="">
        ...
        <!--<div class="row">-->
          <!--<div class="footer-containertent">-->
            ...
            <!--<ul class="footer-social-info">-->
              ...
              <!--</li>-->
            <!--</ul>-->
            <!--<br/><br/>Copyright &copy; 2016.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></div>-->
        <!--</div>-->
      <!--</div>-->
    <!--</footer>-->
  </div>
